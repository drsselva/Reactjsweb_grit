  ...
  <section id="hero" class="hero">
    <div class="container position-relative">
      <div class="row gy-5 banner-wrap">
        <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center relative text-lg-start" >
        ...
        <div class="col-lg-6 order-1 order-lg-2 banner-img text-center">
	...
	<section id="about-us" class="about-us pt-2">
      <div class="container">
        ...
        <div class="row gy-4 align-items-center">
          ...
          <div class="col-xl-6 mb-4 mb-xl-0 service-img text-center"  >
